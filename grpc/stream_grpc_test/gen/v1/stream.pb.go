...
var file_stream_proto_rawDesc = []byte{
	...
	0x53, 0x74, 0x65, 0x61, 0x6d, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52,
	...
	,
...
var file_stream_proto_goTypes = []interface{}{
	(*StreamReqData)(nil), // 0: Steam.StreamReqData
	(*StreamResData)(nil), // 1: Steam.StreamResData
}
var file_stream_proto_depIdxs = []int32{
	0, // 0: Steam.Greeter.GetStream:input_type -> Steam.StreamReqData
	0, // 1: Steam.Greeter.PutStream:input_type -> Steam.StreamReqData
	0, // 2: Steam.Greeter.AllStream:input_type -> Steam.StreamReqData
	1, // 3: Steam.Greeter.GetStream:output_type -> Steam.StreamResData
	1, // 4: Steam.Greeter.PutStream:output_type -> Steam.StreamResData
	1, // 5: Steam.Greeter.AllStream:output_type -> Steam.StreamResData
...
func (c *greeterClient) GetStream(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/Steam.Greeter/GetStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) PutStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_PutStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[1], "/Steam.Greeter/PutStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) AllStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_AllStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[2], "/Steam.Greeter/AllStream", opts...)
	if err != nil {
		return nil, err
	}
