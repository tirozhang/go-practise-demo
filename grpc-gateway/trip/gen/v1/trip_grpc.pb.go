...
type TripServiceClient interface {
	GetTrip(ctx context.Context, in *GetTripReq, opts ...grpc.CallOption) (*GetTripResp, error)
}
...
func (c *tripServiceClient) GetTrip(ctx context.Context, in *GetTripReq, opts ...grpc.CallOption) (*GetTripResp, error) {
	out := new(GetTripResp)
...
type TripServiceServer interface {
	GetTrip(context.Context, *GetTripReq) (*GetTripResp, error)
...
func (UnimplementedTripServiceServer) GetTrip(context.Context, *GetTripReq) (*GetTripResp, error) {
